...
const SidebarAdmin: React.FC = () => {
    ...
    const handleLogout = (e: React.FormEvent) => {
        ...
        swal.fire({
            ...
            customClass:{
                container: 'font-sans',
                popup: 'font-sans',
                confirmButton: 'bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 ml-5 rounded-md',
                cancelButton: 'bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-md',
    ...
    const menuItems = [
        { name: 'Dashboard', icon: 'fa-solid fa-house', href: '/admin' },
        { name: 'Task', icon: 'fa-solid fa-list-check', href: '/admin/task' },
        { name: 'Task History', icon: 'fa-solid fa-clock-rotate-left', href: '/admin/tasklog' },
    ]
    ...
    return (
        ...
        >
            ...
            {/* menu-menu */}
            <nav className="flex-1 overflow-y-auto py-3 px-3 z-40">
